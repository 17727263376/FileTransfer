...
//	}
	...
	public ReceivePage() {
		...
		receiveFilePath.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		choiceFileButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		textField_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		acceptButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		refuseButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		receiveTitleText.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
		...
		toastText.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
