...
public class InitPage extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					UiUtil.showDialogPage("警告：程序已运行或11111端口被占用");
					e1.printStackTrace();
				}
			}
		});
	...
	private InitPage() {
		...
		innerButton.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		...
		outButton.setFont(new Font("微软雅黑", Font.PLAIN, 12));
		outButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//公网连接button
				UiUtil.showDialogPage("此功能正在开发中...");
			}
		});
		...
		txtip_1.setFont(new Font("微软雅黑", Font.PLAIN, 12));
